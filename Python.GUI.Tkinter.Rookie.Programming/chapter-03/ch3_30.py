...
lab3.grid(row=0,column=2,padx=5,pady=5)       # 格状包装
lab4.grid(row=0,column=3,padx=5,pady=5)       # 格状包装
lab5.grid(row=1,column=0,padx=5)       # 格状包装
lab6.grid(row=1,column=1,padx=5)       # 格状包装
lab7.grid(row=1,column=2,padx=5)       # 格状包装
lab8.grid(row=1,column=3,padx=5)       # 格状包装
