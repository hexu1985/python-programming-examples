...
Programming Python 4th Edition, published in January 2011.
...
--You can run many of its examples with the auto-launcher 
  ...
  See the book and PP4E\README-PP4E.txt (a more verbose 
  guide for novices) for details on these scripts.
...
--Mark Lutz, July 2010 (updated November 2010)